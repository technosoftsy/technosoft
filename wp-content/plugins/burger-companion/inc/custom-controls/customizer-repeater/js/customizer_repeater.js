...
jQuery(document).ready(function () {
    ...
    burger_companion_theme_controls.on('click', '.customizer-repeater-new-field', function () {
		...
		if(split_add_more_button_split=="Add New Soci")
        {
			if(jQuery('#exist_burger_companion_OwlPress_Social').val()>=3)
				{
			 ...
			 if(jQuery('#exist_burger_companion_OwlPress_Social').val()<3)
				{
					var new_service_add_val=parseInt(jQuery('#exist_burger_companion_OwlPress_Social').val())+1;
					jQuery('#exist_burger_companion_OwlPress_Social').val(new_service_add_val);  
				}
        }
		...
		if(split_add_more_button_split=="Add New Info")
        {
			if(jQuery('#exist_burger_companion_OwlPress_Information').val()>=4)
				{
			 ...
			 if(jQuery('#exist_burger_companion_OwlPress_Information').val()<4)
				{
					var new_service_add_val=parseInt(jQuery('#exist_burger_companion_OwlPress_Information').val())+1;
					jQuery('#exist_burger_companion_OwlPress_Information').val(new_service_add_val);  
				}
        }
		
		if(split_add_more_button_split=="Add New Slid")
        {
			if(jQuery('#exist_burger_companion_OwlPress_Slider').val()>=3)
				{
            ...
            if(jQuery('#exist_burger_companion_OwlPress_Slider').val()<3)
				{
					var new_service_add_val=parseInt(jQuery('#exist_burger_companion_OwlPress_Slider').val())+1;
					jQuery('#exist_burger_companion_OwlPress_Slider').val(new_service_add_val);  
				}
        }
		...
		if(split_add_more_button_split=="Add New Serv")
        {
			if(jQuery('#exist_burger_companion_OwlPress_Service').val()>=4)
				{
            ...
            if(jQuery('#exist_burger_companion_OwlPress_Service').val()<4)
				{
					var new_service_add_val=parseInt(jQuery('#exist_burger_companion_OwlPress_Service').val())+1;
					jQuery('#exist_burger_companion_OwlPress_Service').val(new_service_add_val);  
				}
        }
		...
		if(split_add_more_button_split=="Add New Feat")
        {
			if(jQuery('#exist_burger_companion_OwlPress_Features').val()>=5)
				{
            ...
            if(jQuery('#exist_burger_companion_OwlPress_Features').val()<5)
				{
					var new_service_add_val=parseInt(jQuery('#exist_burger_companion_OwlPress_Features').val())+1;
					jQuery('#exist_burger_companion_OwlPress_Features').val(new_service_add_val);  
				}
        }
		
		if(split_add_more_button_split=="Add New Cont")
        {
			if(jQuery('#exist_burger_companion_OwlPress_Contact').val()>=2)
				{
            ...
            if(jQuery('#exist_burger_companion_OwlPress_Contact').val()<2)
				{
					var new_service_add_val=parseInt(jQuery('#exist_burger_companion_OwlPress_Contact').val())+1;
					jQuery('#exist_burger_companion_OwlPress_Contact').val(new_service_add_val);  
				}
        }
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
               ...
               console.log( jQuery('#exist_burger_companion_Appetizer_Social').val(parseInt(jQuery('#exist_burger_companion_Appetizer_Social').val())-1));  
				...
				if(split_delete_button_split=="Delete Socia")
                {
               console.log( jQuery('#exist_burger_companion_OwlPress_Social').val(parseInt(jQuery('#exist_burger_companion_OwlPress_Social').val())-1));  
                }
				
				
				if(split_delete_button_split=="Delete Infor")
                {
               console.log( jQuery('#exist_burger_companion_OwlPress_Information').val(parseInt(jQuery('#exist_burger_companion_OwlPress_Information').val())-1));  
                }
				
				
				if(split_delete_button_split=="Delete Slide")
                {
				console.log( jQuery('#exist_burger_companion_OwlPress_Slider').val(parseInt(jQuery('#exist_burger_companion_OwlPress_Slider').val())-1));  
                }
				
				if(split_delete_button_split=="Delete Servi")
                {
				console.log( jQuery('#exist_burger_companion_OwlPress_Service').val(parseInt(jQuery('#exist_burger_companion_OwlPress_Service').val())-1));  
                }
				
				if(split_delete_button_split=="Delete Featu")
                {
				console.log( jQuery('#exist_burger_companion_OwlPress_Features').val(parseInt(jQuery('#exist_burger_companion_OwlPress_Features').val())-1));  
                }
				
				if(split_delete_button_split=="Delete Conta")
                {
				console.log( jQuery('#exist_burger_companion_OwlPress_Contact').val(parseInt(jQuery('#exist_burger_companion_OwlPress_Contact').val())-1));  
                }
